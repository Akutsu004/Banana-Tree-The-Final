import svgPaths from "./svg-2995e1jrk7";
...
function DailyRoundsPatientMonitoringDashboard({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Daily Rounds & Patient Monitoring Dashboard">
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[11.78%_1.9%_84.69%_8.05%] leading-[normal] not-italic text-[24px] text-black">Daily Rounds & Patient Monitoring Dashboard</p>
      ...
      <div className="absolute inset-[18.85%_1.61%_4.48%_7.91%] overflow-clip rounded-[30px]" data-name="patient monitoring">
        <div className="absolute bg-[#8fd0c6] inset-0" />
        ...
        <div className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[12.6%_56.31%_65.28%_1.7%] leading-[24px] text-[24px] text-black text-nowrap tracking-[3.6px] whitespace-pre">
          <p className="mb-0">Patient ID: 2000004</p>
          <p className="mb-0">&nbsp;</p>
          <p className="mb-0">Appointment ID: 9000004</p>
          <p className="mb-0">Doctor-In-Charge: Dr. Pinkman</p>
          <p className="mb-0">Appointment Schedule:</p>
        ...
        <p className="absolute font-['Inter:Bold',_sans-serif] font-bold inset-[40.4%_86.97%_55.91%_1.7%] leading-[24px] not-italic text-[30px] text-nowrap text-white tracking-[4.5px] whitespace-pre">Record:</p>
        <div className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[45.78%_60.68%_32.1%_1.7%] leading-[24px] text-[24px] text-black text-nowrap tracking-[3.6px] whitespace-pre">
          ...
          <p className="mb-0">Underlying Condition: asdf</p>
          <p className="mb-0">Prescription ID:</p>
          <p className="mb-0">Diagnosis:</p>
          <p className="mb-0">Treatment Plan ID:</p>
          <p>Allergies:</p>
        </div>
        ...
        <div className="absolute bg-white inset-[78.95%_1.54%_5.38%_1.7%] rounded-[8px]" />
        <div className="absolute inset-[67.9%_16.91%_23.2%_68.69%] rounded-[50px]" data-name="save draft button">
        ...
        <div className="absolute inset-[67.9%_1.54%_23.2%_84.06%] rounded-[50px]" data-name="save draft button">
          <div className="absolute bg-[#00b7c2] inset-0 rounded-[50px]" />
...
export default function DailyRoundsPatientMonitoringDashboard1() {
  return <DailyRoundsPatientMonitoringDashboard className="relative size-full" />;
}