import svgPaths from "./svg-3fn8unsdxl";
...
function AddTreatmentPlanManagement({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Add Treatment Plan Management">
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[11.78%_10.25%_84.69%_8.05%] leading-[normal] not-italic text-[24px] text-black">Prescription Medication</p>
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Add Prescription Medication UI">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.5%_7.28%_92.5%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Edit Prescription Medication</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[64.14%_72.73%_32.57%_1.38%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Instructions:</p>
        <div className="absolute inset-[69.86%_1.86%_11.57%_1.38%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1196 130">
            <path d={svgPaths.p2cabd580} fill="var(--fill-0, white)" id="Rectangle 55" />
          </svg>
        </div>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[72%_74.19%_25.14%_2.67%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Edit Instructions Here]</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[28%_91.18%_68.71%_1.38%] leading-[normal] text-[18px] text-black text-nowrap tracking-[2.7px] whitespace-pre">Dosage:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[12.71%_43.12%_84%_37.46%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Prescription ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[12.71%_66.26%_84%_1.38%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Prescription Meeication ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[28%_43.12%_68.71%_37.46%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Quantity:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[13%_20.55%_83.71%_60.03%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Medication ID:</p>
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[18.86%_20.55%_74.71%_60.03%] items-start" data-name="Input Field">
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[34%_43.12%_59.57%_37.46%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[34%_66.26%_59.57%_1.38%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[18.86%_43.12%_74.71%_37.46%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[18.86%_66.26%_74.71%_1.38%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
...
export default function AddTreatmentPlanManagement1() {
  return <AddTreatmentPlanManagement className="relative size-full" />;
}