import svgPaths from "./svg-lrh43f0jyp";
...
function EditPrescriptionMedication({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Edit Prescription Medication">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Edit Prescription Medication UI">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[13%_79.21%_83.71%_1.38%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Prescription ID:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[13%_57.85%_83.71%_22.73%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Medication ID:</p>
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[18.86%_79.21%_74.71%_1.38%] items-start" data-name="Input Field">
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[18.86%_57.85%_74.71%_22.73%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
...
export default function EditPrescriptionMedication1() {
  return <EditPrescriptionMedication className="relative size-full" />;
}