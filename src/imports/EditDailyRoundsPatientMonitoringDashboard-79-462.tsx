import svgPaths from "./svg-gh55svzwr7";
...
import { imgIcon, imgIcon1, imgIcon2, imgIcon3, imgIcon4, img } from "./svg-tf1m9";
...
function EditDailyRoundsPatientMonitoringDashboard({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Edit Daily Rounds & Patient Monitoring Dashboard">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Add Daily Rounds & Patient Monitoring">
        ...
        <InputField hasLabel={false} value="Personnel ID" className="absolute content-stretch flex flex-col gap-[8px] inset-[16.14%_78.96%_77.43%_1.62%] items-start" />
        <InputField hasLabel={false} value="Patient ID" className="absolute content-stretch flex flex-col gap-[8px] inset-[16.14%_57.6%_77.43%_22.98%] items-start" />
        <InputField hasLabel={false} value="Appointment ID" className="absolute content-stretch flex flex-col gap-[8px] inset-[16.14%_36.25%_77.43%_44.34%] items-start" />
        <InputField hasLabel={false} className="absolute bottom-[64.14%] content-stretch flex flex-col gap-[8px] items-start left-1/2 right-[30.58%] top-[29.43%]" />
        <InputField hasLabel={false} value="Record ID" className="absolute content-stretch flex flex-col gap-[8px] inset-[42.29%_65.94%_51.29%_1.7%] items-start" />
        <InputField hasLabel={false} className="absolute content-stretch flex flex-col gap-[8px] inset-[29.43%_52.83%_64.14%_27.75%] items-start" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_78.96%_85.29%_1.62%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Doctor-In-Charge:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_35.44%_85.29%_44.34%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Treatment Plan ID:</p>
        <SelectField hasLabel={false} value="MM/DD/YYYY" className="absolute content-stretch flex flex-col gap-[8px] inset-[29.43%_78.96%_64.86%_1.62%] items-start" />
      </div>
    </div>
  );
}

export default function EditDailyRoundsPatientMonitoringDashboard1() {
  return <EditDailyRoundsPatientMonitoringDashboard className="relative size-full" />;
}