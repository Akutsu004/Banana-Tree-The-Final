import svgPaths from "./svg-b6352i0901";
...
function AddLabResultsPatientHistory({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Add Lab Results & Patient History">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Add Patient History">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.5%_7.28%_92.5%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Add Patient History</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[24%_66.34%_72.71%_1.7%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Underlying COndition:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[24%_43.69%_72.71%_36.89%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Prescription ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[36.57%_40.45%_60.14%_36.89%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Treatment Plan ID:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[72.86%_81.96%_24.29%_1.7%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Edit Notes Here]</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[36.57%_87.54%_60.14%_1.7%] leading-[normal] text-[18px] text-black text-nowrap tracking-[2.7px] whitespace-pre">Diagnosis:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[49.43%_87.54%_47.29%_1.7%] leading-[normal] text-[18px] text-black text-nowrap tracking-[2.7px] whitespace-pre">Allergies:</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[16.57%_36.25%_77%_44.34%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[16.57%_14.97%_77%_65.61%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Appointment ID</p>
              </div>
            </div>
            <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-[-0.5px] pointer-events-none rounded-[8.5px]" />
          </div>
        </div>
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[28.71%_66.02%_64.86%_1.62%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[41.57%_65.94%_52%_1.7%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[54.43%_65.94%_39.14%_1.7%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[28.71%_43.69%_64.86%_36.89%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[42%_43.69%_51.57%_36.89%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_78.88%_85.29%_1.7%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Patient ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_57.6%_85.29%_22.98%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Record ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_36.25%_85.29%_44.34%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Doctor-In-Charge:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_14.97%_85.29%_65.61%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Appointment ID:</p>
      </div>
    </div>
  );
}

export default function AddLabResultsPatientHistory1() {
  return <AddLabResultsPatientHistory className="relative size-full" />;
}