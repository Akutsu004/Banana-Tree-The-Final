import svgPaths from "./svg-k9dhsgihmt";
...
function EditLabResultsPatientHistory({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Edit Lab Results & Patient History">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Add Patient History">
        ...
        <InputField hasLabel={false} value="Record ID" className="absolute content-stretch flex flex-col gap-[8px] inset-[15.86%_78.96%_77.71%_1.62%] items-start" />
        <InputField hasLabel={false} value="Personnel ID" className="absolute content-stretch flex flex-col gap-[8px] inset-[15.86%_57.6%_77.71%_22.98%] items-start" />
        <InputField hasLabel={false} value="Appointment ID" className="absolute content-stretch flex flex-col gap-[8px] inset-[15.86%_36.25%_77.71%_44.34%] items-start" />
        ...
        <InputField hasLabel={false} className="absolute content-stretch flex flex-col gap-[8px] inset-[41.57%_65.94%_52%_1.7%] items-start" />
        <InputField hasLabel={false} className="absolute content-stretch flex flex-col gap-[8px] inset-[54.43%_65.94%_39.14%_1.7%] items-start" />
        <InputField hasLabel={false} className="absolute content-stretch flex flex-col gap-[8px] inset-[28.71%_43.69%_64.86%_36.89%] items-start" />
        <InputField hasLabel={false} className="absolute content-stretch flex flex-col gap-[8px] inset-[42%_43.69%_51.57%_36.89%] items-start" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_78.96%_85.29%_1.62%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Record ID:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_36.25%_85.29%_44.34%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Appointment ID:</p>
      </div>
    </div>
  );
}

export default function EditLabResultsPatientHistory1() {
  return <EditLabResultsPatientHistory className="relative size-full" />;
}