import svgPaths from "./svg-lwwd0emoxr";
...
import { imgRipple, img } from "./svg-4vq3f";
...
function PatientHistoryTable({ className }: { className?: string }) {
  return (
    <div className={className} data-name="patient history table">
      ...
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_44.17%_95.81%_38.84%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Underlying Condition</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_34.47%_95.81%_55.83%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Prescription ID</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_22.33%_95.81%_65.53%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Diagnosis</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_10.19%_95.81%_77.67%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Treatment Plan ID</p>
      ...
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_61.16%_95.81%_29.13%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Appointment ID</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_70.87%_95.81%_19.42%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Patient ID</p>
      <p className="absolute bottom-[95.81%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[90.29%] text-[10px] text-center text-white top-[2.26%] tracking-[1.5px]">Record ID</p>
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[55.83%] right-[44.17%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[65.53%] right-[34.47%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <p className="absolute bottom-[90.16%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[90.29%] text-[12px] text-black text-center top-[7.42%] tracking-[1.8px]">2000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_80.58%_90.16%_9.71%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">2000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_70.87%_90.16%_19.42%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">2000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_61.16%_90.16%_29.13%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">06/01/1998</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_44.17%_90.16%_38.84%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">tooth condition</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_10.19%_90.16%_77.67%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">5000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_80.58%_95.81%_9.71%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Personnel ID</p>
      <ActionButtons className="absolute inset-[7.42%_1.46%_87.74%_91.26%]" />
    </div>
  );
}
...
function LabResultsPatientHistoryPatientList({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Lab Results & Patient History (patient list)">
      ...
      <PatientHistoryTable className="absolute inset-[24.73%_1.61%_2.24%_7.91%]" />
      <div className="absolute inset-[18.85%_1.46%_77.62%_83.89%]" data-name="Add 2">
        ...
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-[114.5px] text-[10px] text-center text-nowrap text-white top-[9px] tracking-[1.5px] translate-x-[-50%] whitespace-pre">Add L.R./P.H.</p>
...
export default function LabResultsPatientHistoryPatientList1() {
  return <LabResultsPatientHistoryPatientList className="relative size-full" />;
}