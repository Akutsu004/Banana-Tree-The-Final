import svgPaths from "./svg-fz438yjzbc";
...
function DentalChart({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Dental Chart">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Component 3">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[3%_5.83%_93%_3.07%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Patient Chart: Mihoyo Bloodborne (ID: 2000001)</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_57.77%_83.86%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Dental Chart ID:</p>
        <div className="absolute bg-white inset-[13.71%_1.62%_33.71%_58.17%]" />
        <div className="absolute bg-white inset-[73.71%_1.62%_12.14%_1.62%] rounded-[8px]" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[34.86%_62.3%_60.43%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Condition:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[46.57%_62.3%_48.71%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Surface:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[23.14%_62.3%_72.14%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Tooth Number:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[66.29%_89.89%_29.43%_1.62%] leading-[normal] text-[24px] text-nowrap text-white tracking-[3.6px] whitespace-pre">Notes:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[61.57%_62.3%_33.71%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Status Date:</p>
        <div className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[33.71%_10.92%_57.71%_67.48%] leading-[normal] text-[24px] text-black text-center text-nowrap tracking-[3.6px] whitespace-pre">
...
export default function DentalChart1() {
  return <DentalChart className="relative size-full" />;
}