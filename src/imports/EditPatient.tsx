import svgPaths from "./svg-422tamz369";
...
function EditPatient({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Edit Patient">
      ...
      <div className="absolute inset-[17.08%_1.61%_0.47%_7.91%] rounded-[30px]" data-name="Add Patient UI">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.5%_7.28%_92.5%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Edit Patient</p>
...
export default function EditPatient1() {
  return <EditPatient className="relative size-full" />;
}