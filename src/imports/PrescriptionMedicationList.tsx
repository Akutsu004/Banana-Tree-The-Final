import svgPaths from "./svg-p6pkvw7lks";
...
import { imgRipple, img } from "./svg-aozm8";
...
function PrescriptionMedicationTable({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Prescription Medication Table">
      ...
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_15.05%_95.81%_45.31%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Instructions</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_7.77%_95.81%_84.95%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Quantity</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_80.58%_95.81%_9.71%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Prescription ID</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_70.87%_95.81%_19.42%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Medication ID</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_54.69%_95.81%_29.13%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Dosage</p>
      <p className="absolute bottom-[94.68%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[90.29%] text-[10px] text-center text-white top-[1.29%] tracking-[1.5px]">Prescription Medication ID</p>
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[84.95%] right-[15.05%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[45.31%] right-[54.69%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <p className="absolute bottom-[90.16%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[90.29%] text-[12px] text-black text-center top-[7.42%] tracking-[1.8px]">6000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_80.58%_90.16%_9.71%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">7000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_54.69%_90.16%_29.13%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">1001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_15.05%_90.16%_45.31%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">varchar(255) NOT NULL</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_70.87%_90.16%_19.42%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">8000001</p>
...
function PrescriptionMedicationList({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Prescription Medication List">
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[11.78%_10.25%_84.69%_8.05%] leading-[normal] not-italic text-[24px] text-black">Prescriptions (Patient List)</p>
      ...
      <PrescriptionMedicationTable className="absolute inset-[24.73%_1.46%_2.24%_8.05%]" />
      <div className="absolute inset-[18.85%_1.61%_77.62%_80.09%]" data-name="Add 2">
        <div className="absolute bg-[#00b7c2] h-[30px] left-0 right-0 top-0" />
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-[141.5px] text-[10px] text-center text-nowrap text-white top-[9px] tracking-[1.5px] translate-x-[-50%] whitespace-pre">Add Prescription Medication</p>
      ...
      <div className="absolute inset-[18.85%_21.74%_77.62%_56.3%]" data-name="Add 3">
        <div className="absolute bg-[#00b7c2] h-[30px] left-0 right-0 top-0" />
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-[150.5px] text-[10px] text-center text-nowrap text-white top-[9px] tracking-[1.5px] translate-x-[-50%] whitespace-pre">Switch to Prescription List</p>
      </div>
    </div>
  );
}

export default function PrescriptionMedicationList1() {
  return <PrescriptionMedicationList className="relative size-full" />;
}