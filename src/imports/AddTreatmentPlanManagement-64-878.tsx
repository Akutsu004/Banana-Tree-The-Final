import svgPaths from "./svg-rl6pybtsxg";
  ...
  return (
    <div className={className} data-name="Add Treatment Plan Management">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Edit Patient Prescription UI">
        ...
        <InputField hasLabel={false} className="absolute content-stretch flex flex-col gap-[8px] inset-[19.29%_57.04%_74.29%_23.54%] items-start" />
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.5%_7.28%_92.5%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Edit Patient’s Treatment Plan</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[37.86%_72.49%_58.86%_1.62%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Treatment Plan:</p>
        <div className="absolute inset-[66.43%_1.86%_15%_1.38%]">
        ...
        <div className="absolute inset-[42.43%_1.86%_39%_1.38%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1196 130">
            <path d={svgPaths.p2cabd580} fill="var(--fill-0, white)" id="Rectangle 55" />
          </svg>
        </div>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[43.86%_74.19%_53.29%_1.7%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Add Treatment Plan Here]</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[68.14%_82.93%_29%_1.7%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Add Notes Here]</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[62.29%_92.96%_34.86%_1.38%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">Notes:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[13%_79.21%_83.71%_1.38%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Patient ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[13%_57.04%_83.71%_23.54%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Record ID:</p>
      </div>
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[11.78%_10.25%_84.69%_8.05%] leading-[normal] not-italic text-[24px] text-black">Treatment Plan Management</p>
