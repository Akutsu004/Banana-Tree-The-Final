import svgPaths from "./svg-72g771a0l6";
...
import { imgIcon, imgIcon1, imgIcon2, imgIcon3, imgIcon4, img } from "./svg-7mz0v";
...
function AddPatientCharting({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Add Patient Charting">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Edit Patient Prescription UI">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_40.7%_85.29%_22.98%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Dental Chart ID:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[66.57%_82.93%_30.57%_1.7%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Add Notes Here]</p>
        ...
        <InputField hasLabel={false} className="absolute content-stretch flex flex-col gap-[8px] inset-[16.14%_57.6%_77.43%_22.98%] items-start" />
...
export default function AddPatientCharting1() {
  return <AddPatientCharting className="relative size-full" />;
}