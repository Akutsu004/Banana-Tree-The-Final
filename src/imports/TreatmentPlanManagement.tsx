import svgPaths from "./svg-0f5ohgvdpo";
...
function TreatmentPlanManagement({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Treatment Plan Management">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Component 5">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.5%_7.28%_92.5%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Patient Chart: John Dela Cruz (ID: 2000002)</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[13.67%_57.36%_82.33%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Record ID: 4000002</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[18.43%_57.36%_77.57%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Treatment Plan:</p>
        <div className="absolute bg-white inset-[24.43%_1.62%_44.14%_1.62%]" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[13.71%_1.62%_81.57%_42.64%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Entered by: Dr. Pinkman</p>
        <div className="absolute bg-white inset-[62.86%_1.62%_12.29%_1.62%]" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[57%_89.89%_38.71%_1.62%] leading-[normal] text-[24px] text-nowrap text-white tracking-[3.6px] whitespace-pre">Notes:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[26.14%_29.45%_69.57%_2.43%] leading-[normal] text-[24px] text-black text-nowrap tracking-[3.6px] whitespace-pre">list/procedure on the treatment for the patient</p>
...
export default function TreatmentPlanManagement1() {
  return <TreatmentPlanManagement className="relative size-full" />;
}