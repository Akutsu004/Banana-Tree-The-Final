import svgPaths from "./svg-mgaydqwbhj";
...
function EmployeeInfo({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Employee Info">
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[11.78%_10.25%_84.69%_8.05%] leading-[normal] not-italic text-[24px] text-black">Employee Info</p>
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[17.67%_52.93%_75.85%_27.67%] leading-[normal] not-italic text-[48px] text-black text-nowrap whitespace-pre">Sofia Smith</p>
      <div className="absolute bg-[forestgreen] inset-[49.47%_49.63%_3.42%_8.27%] rounded-[30px]" data-name="Component 2">
        ...
        <div className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[17.75%_2.09%_3%_2.44%] leading-[40px] text-[24px] text-black tracking-[3.6px]">
          <p className="mb-0">
            Name: <span className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold">Sofia Smith</span>
          </p>
          <p className="mb-0">Age: 30</p>
          <p className="mb-0">Sex:Female</p>
      ...
      <div className="absolute bg-[forestgreen] inset-[49.47%_1.46%_3.42%_56.44%] rounded-[30px]" data-name="information box">
        <div className="absolute bg-[#2a7a6e] inset-0 rounded-[30px]" />
        <div className="absolute bg-[#8fd0c6] bottom-[85.5%] left-0 right-0 rounded-tl-[30px] rounded-tr-[30px] top-0" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.25%_15.48%_87.75%_15.48%] leading-[40px] text-[24px] text-black text-center tracking-[3.6px]">EMPLOYEE INFORMATION</p>
        <div className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[17.75%_2.09%_3%_2.44%] leading-[40px] text-[24px] text-black tracking-[3.6px]">
          <p className="mb-0">Employee ID: 1000001</p>
          <p className="mb-0">&nbsp;</p>
          <p>&nbsp;</p>
        </div>
      </div>
...
export default function EmployeeInfo1() {
  return <EmployeeInfo className="relative size-full" />;
}