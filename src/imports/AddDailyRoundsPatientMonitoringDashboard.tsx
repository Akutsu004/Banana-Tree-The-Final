import svgPaths from "./svg-4okqu69taj";
...
function AddDailyRoundsPatientMonitoringDashboard({ className }: { className?: string }) {
  return (
    <div className={className} data-name="ADD DAILY ROUNDS & PATIENT MONITORING DASHBOARD">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Add Daily Rounds & Patient Monitoring">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[72.86%_82.93%_24.29%_1.7%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Add Notes Here]</p>
...
export default function AddDailyRoundsPatientMonitoringDashboard1() {
  return <AddDailyRoundsPatientMonitoringDashboard className="relative size-full" />;
}