import svgPaths from "./svg-cnnewntnxc";
...
function EditTreatmentPlanManagement({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Edit Treatment Plan Management">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Edit Patient Prescription UI">
        ...
        <InputField hasLabel={false} className="absolute content-stretch flex flex-col gap-[8px] inset-[19.86%_79.21%_73.71%_1.38%] items-start" />
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[36.14%_72.73%_60.57%_1.38%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Treatment Plan:</p>
        <div className="absolute inset-[68.14%_1.86%_13.29%_1.38%]">
        ...
        <div className="absolute inset-[41.86%_1.86%_39.57%_1.38%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1196 130">
            <path d={svgPaths.p2cabd580} fill="var(--fill-0, white)" id="Rectangle 55" />
          </svg>
        </div>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[43.43%_72.82%_53.71%_2.1%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Edit Treatment Plan Here]</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[70%_81.96%_27.14%_1.7%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Edit Notes Here]</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[62.86%_92.96%_34.29%_1.38%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">Notes:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[14.14%_79.21%_82.57%_1.38%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Record ID:</p>
      </div>
...
export default function EditTreatmentPlanManagement1() {
  return <EditTreatmentPlanManagement className="relative size-full" />;
}