import svgPaths from "./svg-vtm2o34kgn";
...
import { imgRipple, img } from "./svg-6hl7v";
...
function Add2({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Add 2">
      <div className="absolute bg-[#00b7c2] h-[30px] left-0 right-0 top-0" />
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-[114.5px] text-[10px] text-center text-nowrap text-white top-[9px] tracking-[1.5px] translate-x-[-50%] whitespace-pre">Add Prescription</p>
...
function PrescriptionsList({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Prescriptions List">
      <WebpageBackground className="absolute inset-0" />
      <div className="absolute inset-[24.73%_1.46%_2.24%_8.05%]" data-name="Prescription Medication Table">
        ...
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_7.77%_95.81%_45.31%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Notes</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_80.58%_95.81%_9.71%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Patient ID</p>
        <p className="absolute bottom-[95.81%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[90.29%] text-[10px] text-center text-white top-[2.26%] tracking-[1.5px]">Prescription ID</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_64.4%_95.81%_19.42%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Prescription Date</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_54.69%_95.81%_35.6%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Personnel ID</p>
        ...
        <div className="absolute bottom-0 flex items-center justify-center left-[35.6%] right-[64.4%] top-0">
          <div className="flex-none">
            <div className="relative size-full">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
        ...
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_54.69%_90.16%_35.6%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">1001</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_7.77%_90.16%_45.31%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">varchar(255) NOT NULL</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_64.4%_90.16%_19.42%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">date</p>
      </div>
      ...
      <Add2 className="absolute inset-[18.85%_1.46%_77.62%_83.89%]" />
      <div className="absolute inset-[18.85%_17.94%_77.62%_60.1%]" data-name="Add 3">
        <div className="absolute bg-[#00b7c2] h-[30px] left-0 right-0 top-0" />
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-[150px] text-[10px] text-center text-nowrap text-white top-[9px] tracking-[1.5px] translate-x-[-50%] whitespace-pre">Switch to Prescription Medication List</p>
      </div>
      <ActionButtons className="absolute inset-[30.15%_1.68%_66.31%_91.73%]" />
    </div>
  );
}

export default function PrescriptionsList1() {
  return <PrescriptionsList className="relative size-full" />;
}