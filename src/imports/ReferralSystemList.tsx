import svgPaths from "./svg-vastdrvpje";
...
import { imgRipple, img } from "./svg-x5bje";
...
function ReferralSystemTable({ className }: { className?: string }) {
  return (
    <div className={className} data-name="REFERRAL SYSTEM TABLE">
      <div className="absolute bottom-[93.55%] left-0 right-0 top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1600 40">
          <path d="M0 0H1600V40H0V0Z" fill="var(--fill-0, #2A7A6E)" id="Rectangle 11" />
        </svg>
      </div>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_38.13%_95.81%_48.75%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Receiving Provider</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_28.75%_95.81%_61.88%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Priority</p>
      <p className="absolute bottom-[95.81%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-[90.63%] right-0 text-[10px] text-center text-white top-[2.26%] tracking-[1.5px]">Action</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_64.38%_95.81%_22.5%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Reason for Referral</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_77.5%_95.81%_15%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Patient ID</p>
      <p className="absolute bottom-[95.81%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[92.5%] text-[10px] text-center text-white top-[2.26%] tracking-[1.5px]">Referral ID</p>
      <div className="absolute bg-white bottom-0 left-0 right-0 top-[6.45%]" />
      <div className="absolute bottom-0 flex items-center justify-center left-[15%] right-[85%] top-0">
      ...
      <div className="absolute bottom-full left-0 right-0 top-0">
        <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1600 1">
            <line id="Line 16" stroke="var(--stroke-0, black)" x2="1600" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-0 flex items-center justify-center left-[7.5%] right-[92.5%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[48.75%] right-[51.25%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[71.25%] right-[28.75%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[61.88%] right-[38.13%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[90.63%] right-[9.38%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[35.63%] right-[64.38%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <div className="absolute bottom-0 flex items-center justify-center left-[22.5%] right-[77.5%] top-0">
        <div className="flex-none">
          <div className="relative size-full">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
      ...
      <p className="absolute bottom-[90.16%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[92.5%] text-[12px] text-black text-center top-[7.42%] tracking-[1.8px]">2000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_85%_90.16%_7.5%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">2000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_77.5%_90.16%_15%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">2000001</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_64.38%_90.16%_22.5%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">varchar(255)</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_51.25%_90.16%_35.63%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">varchar(255)</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_38.13%_90.16%_48.75%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">varchar(255)</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_28.75%_90.16%_61.88%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">varchar(50)</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_21.25%_90.16%_71.25%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">DATE</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_85%_95.81%_7.5%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Personnel ID</p>
      <ActionButtons className="absolute inset-[7.42%_1.88%_87.74%_92.5%]" />
      ...
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_51.25%_95.81%_35.63%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Specialty Needed</p>
      <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_21.25%_95.81%_71.25%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Requested Date</p>
...
function ReferralSystemList({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Referral System List">
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[11.78%_10.25%_84.69%_8.05%] leading-[normal] not-italic text-[24px] text-black">Lab Results & Patient History</p>
      ...
      <ReferralSystemTable className="absolute inset-[24.73%_-25.18%_2.24%_8.05%]" />
      <div className="absolute inset-[18.85%_1.46%_77.62%_83.89%]" data-name="Add 2">
        ...
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-[114.5px] text-[10px] text-center text-nowrap text-white top-[9px] tracking-[1.5px] translate-x-[-50%] whitespace-pre">Add Referral</p>
...
export default function ReferralSystemList1() {
  return <ReferralSystemList className="relative size-full" />;
}