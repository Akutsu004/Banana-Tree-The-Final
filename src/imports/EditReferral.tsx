import svgPaths from "./svg-oc1odk1fzm";
...
function EditReferral({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Edit Referral">
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[11.78%_10.25%_84.69%_8.05%] leading-[normal] not-italic text-[24px] text-black">Referral System</p>
      ...
      <div className="absolute inset-[17.08%_1.46%_-11.31%_8.05%]" data-name="Add Referral UI">
        <div className="absolute bg-[#2a7a6e] inset-0 rounded-[30px]" />
        <div className="absolute bg-[#8fd0c6] bottom-[91.25%] left-0 right-0 rounded-tl-[30px] rounded-tr-[30px] top-0" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.19%_7.28%_93.44%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Edit Referral</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[22%_66.42%_75.13%_1.62%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Reasons for Referral:</p>
        <div className="absolute inset-[71.25%_1.62%_13.75%_1.62%]">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[73%_80.66%_24.5%_2.99%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">[Edit Notes Here]</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[33.25%_80.02%_63.88%_1.62%] leading-[normal] text-[18px] text-black text-nowrap tracking-[2.7px] whitespace-pre">Specialty Needed:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[44.5%_77.83%_52.63%_1.62%] leading-[normal] text-[18px] text-black text-nowrap tracking-[2.7px] whitespace-pre">Receiving Provider:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[55.75%_88.75%_41.38%_1.62%] leading-[normal] text-[18px] text-black text-nowrap tracking-[2.7px] whitespace-pre">Priority:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[67%_92.72%_30.5%_1.62%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">Notes:</p>
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[15%_78.96%_80%_1.62%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Patient ID</p>
              </div>
            </div>
            <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-[-0.5px] pointer-events-none rounded-[8.5px]" />
          </div>
        </div>
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[15%_57.6%_80%_22.98%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Record ID</p>
              </div>
            </div>
            <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-[-0.5px] pointer-events-none rounded-[8.5px]" />
          </div>
        </div>
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[15%_36.25%_80%_44.34%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Personnel ID</p>
              </div>
            </div>
            <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-[-0.5px] pointer-events-none rounded-[8.5px]" />
          </div>
        </div>
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[26.25%_1.54%_68.75%_1.62%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[37.5%_1.54%_57.5%_1.7%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[48.75%_1.54%_46.25%_1.7%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[60%_57.6%_35%_1.62%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-none min-h-px min-w-px not-italic relative shrink-0 text-[#1e1e1e] text-[16px]">Value</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[10.75%_78.96%_86.38%_1.62%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Referral ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[10.75%_57.6%_86.38%_22.98%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Patient ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[10.75%_36.25%_86.38%_44.34%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Personnel ID:</p>
        <div className="absolute bg-[#8fd0c6] bottom-0 left-0 right-0 rounded-bl-[30px] rounded-br-[30px] top-[91.25%]" />
        <div className="absolute inset-[92%_83.9%_0.75%_1.7%] rounded-[50px]" data-name="save draft button">
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[60%_36.25%_35%_44.34%] items-start" data-name="Select Field">
...
export default function EditReferral1() {
  return <EditReferral className="relative size-full" />;
}