import svgPaths from "./svg-lghsc0od2l";
...
import { imgRipple, img } from "./svg-awbpr";
...
function TreatmentPlanManagementPatientList({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Treatment Plan Management (Patient List)">
      ...
      <p className="absolute font-['Arial:Bold',_sans-serif] inset-[11.78%_10.25%_84.69%_8.05%] leading-[normal] not-italic text-[24px] text-black">Treatment Plan Management (Patient List)</p>
      ...
      <div className="absolute inset-[24.73%_1.46%_2.24%_8.05%]" data-name="patient table">
        ...
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_17.48%_95.81%_41.26%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Notes</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_7.77%_95.81%_82.52%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Status</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_78.16%_95.81%_12.14%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Patient ID</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_68.45%_95.81%_21.84%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Record ID</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[2.26%_58.74%_95.81%_31.55%] leading-[normal] text-[10px] text-center text-white tracking-[1.5px]">Personnel ID</p>
        <p className="absolute bottom-[95.81%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[87.86%] text-[10px] text-center text-white top-[2.26%] tracking-[1.5px]">Treatment Plan ID</p>
        ...
        <div className="absolute bottom-0 flex items-center justify-center left-[12.14%] right-[87.86%] top-0">
          <div className="flex-none">
            <div className="relative size-full">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
        ...
        <div className="absolute bottom-0 flex items-center justify-center left-[41.26%] right-[58.74%] top-0">
          <div className="flex-none">
            <div className="relative size-full">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
        ...
        <div className="absolute bottom-0 flex items-center justify-center left-[31.55%] right-[68.45%] top-0">
          <div className="flex-none">
            <div className="relative size-full">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 620 1">
        ...
        <p className="absolute bottom-[90.16%] font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-0 right-[87.86%] text-[12px] text-black text-center top-[7.42%] tracking-[1.8px]">5000001</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_78.16%_90.16%_12.14%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">2000001</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_58.74%_90.16%_31.55%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">1001</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_17.48%_90.16%_41.26%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">varchar(255) NOT NULL</p>
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal inset-[7.42%_68.45%_90.16%_21.84%] leading-[normal] text-[12px] text-black text-center tracking-[1.8px]">4000001</p>
      </div>
      <div className="absolute inset-[18.85%_1.46%_77.62%_83.89%]" data-name="Add 2">
        ...
        <p className="absolute font-['Source_Code_Pro:Regular',_sans-serif] font-normal leading-[normal] left-[114.5px] text-[10px] text-center text-nowrap text-white top-[9px] tracking-[1.5px] translate-x-[-50%] whitespace-pre">Add Treatment Plan</p>
      ...
      <ActionButtons className="absolute inset-[29.8%_1.68%_66.67%_91.73%]" />
    </div>
  );
}

export default function TreatmentPlanManagementPatientList1() {
  return <TreatmentPlanManagementPatientList className="relative size-full" />;
}