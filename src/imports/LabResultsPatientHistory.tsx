import svgPaths from "./svg-81atb4piwj";
...
function LabResultsPatientHistory({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Lab Results & Patient History">
      ...
      <div className="absolute inset-[18.26%_1.61%_5.07%_7.91%] overflow-clip rounded-[30px]" data-name="patient record">
        <div className="absolute bg-[#8fd0c6] inset-0" />
        ...
        <div className="absolute flex flex-col font-['Inter:Bold',_sans-serif] font-bold inset-[3.38%_1.54%_88.94%_1.7%] justify-center leading-[0] not-italic text-[48px] text-white tracking-[7.2px]">
          <p className="leading-[24px]">Mark Solomon</p>
        </div>
        <div className="absolute font-['Arial:Bold',_sans-serif] inset-[12.6%_56.31%_17.36%_1.7%] leading-[24px] not-italic text-[24px] text-black text-nowrap tracking-[0.5px] whitespace-pre">
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Patient ID: 2000004</p>
          <p className="mb-0">&nbsp;</p>
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Record ID:</p>
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Doctor-In-Charge: Dr. Pinkman</p>
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Appointment ID: 9000004</p>
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Underlying Condition: asdf</p>
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Prescription ID:</p>
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Diagnosis:</p>
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Treatment Plan ID:</p>
          <p className="font-['Source_Code_Pro:Bold',_sans-serif] font-bold mb-0 tracking-[2.4px]">Allergies:</p>
          <p className="mb-0">&nbsp;</p>
          <p>&nbsp;</p>
        </div>
        <div className="absolute inset-[56.84%_81.63%_34.26%_1.7%] rounded-[50px]" data-name="save draft button" />
        ...
        <div className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[29.19%_6.23%_63.44%_75.08%] leading-[24px] text-[24px] text-black text-center text-nowrap tracking-[3.6px] whitespace-pre">
          <p className="mb-0">Tooth Diagram</p>
          <p>(optional)</p>
        </div>
      </div>
      <div className="absolute inset-[85.28%_77.53%_7.89%_9.44%] rounded-[50px]" data-name="save draft button">
      ...
      <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[59.01%_82.72%_38.16%_9.59%] leading-[24px] text-[24px] text-nowrap text-white tracking-[3.6px] whitespace-pre">Notes:</p>
      <div className="absolute bg-white inset-[63.6%_3%_24.38%_9.44%] rounded-[8px]" />
      <div className="absolute inset-[85.28%_63.54%_7.89%_23.43%] rounded-[50px]" data-name="save draft button">
        <div className="absolute bg-[#00b7c2] inset-0 rounded-[50px]" />
...
export default function LabResultsPatientHistory1() {
  return <LabResultsPatientHistory className="relative size-full" />;
}