import svgPaths from "./svg-ihscqrlx5o";
...
function Prescriptions({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Prescriptions">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Component 6">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.5%_7.28%_92.5%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Patient Name: Mihoyo Bloodborne (ID: 2000001)</p>
        <div className="absolute bg-white inset-[24.43%_1.62%_55%_1.62%]" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[25.71%_26.94%_71%_1.86%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Medication</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[25.71%_12.3%_71%_76.62%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Dosage</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[25.71%_2.91%_71%_90.61%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Qty.</p>
        <div className="absolute bg-white inset-[74.57%_1.62%_12.29%_1.62%]" />
        <div className="absolute bg-white inset-[53%_1.62%_33.86%_1.62%]" />
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[54.43%_55.91%_42.71%_2.51%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">instruction on how and when to use medicine</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[75.29%_94.42%_21.86%_1.86%] leading-[normal] text-[16px] text-black text-nowrap tracking-[2.4px] whitespace-pre">asdf</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[47%_79.69%_48.71%_1.62%] leading-[normal] text-[24px] text-nowrap text-white tracking-[3.6px] whitespace-pre">Instructions:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[68.57%_89.89%_27.14%_1.62%] leading-[normal] text-[24px] text-nowrap text-white tracking-[3.6px] whitespace-pre">Notes:</p>
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.57%_54.77%_84.14%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Prescription Date: 06/25/2025</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[17.43%_54.77%_78.29%_1.62%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Prescriptions:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.57%_1.38%_84.14%_55.42%] leading-[normal] text-[24px] text-white tracking-[3.6px]">Entered by: some doctor</p>
        <div className="absolute flex inset-[24.43%_24.92%_55%_75.08%] items-center justify-center">
          <div className="flex-none">
            <div className="relative size-full">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 144 1">
                  <line id="Line 21" stroke="var(--stroke-0, black)" x2="144" y1="0.5" y2="0.5" />
                </svg>
              </div>
            </div>
          </div>
        </div>
        <div className="absolute flex inset-[24.43%_11%_55%_89%] items-center justify-center">
          <div className="flex-none">
            <div className="relative size-full">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 144 1">
        ...
        <div className="absolute inset-[90.86%_68.61%_0.86%_16.99%] rounded-[50px]" data-name="save draft button">
          <div className="absolute bg-[#00b7c2] inset-0 rounded-[50px]" />
...
export default function Prescriptions1() {
  return <Prescriptions className="relative size-full" />;
}