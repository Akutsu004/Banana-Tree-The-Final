import svgPaths from "./svg-015sgp52dc";
...
function AddReferral({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Add Referral">
      ...
      <div className="absolute inset-[17.08%_1.46%_-11.31%_8.05%]" data-name="Add Referral UI">
        ...
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.19%_7.28%_93.44%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">Add Referral</p>
...
export default function AddReferral1() {
  return <AddReferral className="relative size-full" />;
}