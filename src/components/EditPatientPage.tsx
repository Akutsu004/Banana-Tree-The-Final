...
import svgPaths from "../imports/svg-422tamz369";
...
export function EditPatientPage({ currentUser, onBack, onSave, onLogout, patient }: EditPatientPageProps) {
  ...
  return (
    <div className="relative size-full" data-name="Edit Patient">
      {/* Background */}
      ...
      {/* Edit Patient Form */}
      <div className="absolute inset-[17.08%_1.61%_0.47%_1.46%] rounded-[30px]" data-name="Edit Patient UI">
