...
export function AddLabResultsPage({ currentUser, onBack, onSave, onLogout }: AddLabResultsPageProps) {
  ...
  return (
    <div className="relative size-full" data-name="ADD LAB RESULTS & PATIENT HISTORY">
      ...
      <div className="absolute inset-[17.08%_1.46%_0.47%_8.05%] rounded-[30px]" data-name="Add Lab Results & Patient History">
        ...
        <div className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[2.5%_7.28%_92.5%_1.62%] leading-[normal] text-[24px] text-black tracking-[3.6px]">
          <p className="mb-0">Add Lab Results & Patient History</p>
          <p>&nbsp;</p>
        </div>
        
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_78.88%_85.29%_1.7%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Patient Name:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_57.6%_85.29%_22.98%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Patient ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_36.25%_85.29%_44.34%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Record ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[11.43%_14.16%_85.29%_65.61%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Personnel ID:</p>
        
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[24%_66.34%_72.71%_1.7%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Lab Test Type:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[24%_52.83%_72.71%_27.75%] leading-[normal] text-[18px] text-black tracking-[2.7px]">Test Date:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[24%_40.29%_72.71%_50.08%] leading-[normal] text-[18px] text-black text-nowrap tracking-[2.7px] whitespace-pre">Appointment ID:</p>
        <p className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[36.86%_76.7%_59.86%_1.62%] leading-[normal] text-[18px] text-black text-nowrap tracking-[2.7px] whitespace-pre">Treatment Plan ID:</p>
            ...
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <input
                  ...
                  onChange={(e) => updateForm('personnelId', e.target.value)}
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[29.43%_78.96%_64.86%_1.62%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <input
                  ...
                  onChange={(e) => updateForm('labTestType', e.target.value)}
        ...
        <div className="absolute content-stretch flex flex-col gap-[8px] inset-[29.43%_40.29%_64.14%_50.08%] items-start" data-name="Input Field">
          <div className="bg-white min-w-[240px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
            <div className="flex flex-row items-center min-w-inherit overflow-clip rounded-[inherit] size-full">
              <div className="box-border content-stretch flex items-center min-w-inherit px-[16px] py-[12px] relative w-full">
                <input
