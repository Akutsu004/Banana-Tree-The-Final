...
export function ViewDailyRoundsPage({ currentUser, onBack, onEdit, onLogout, record }: ViewDailyRoundsPageProps) {
  return (
    <div className="relative size-full" data-name="Daily Rounds & Patient Monitoring Dashboard">
      ...
      <div className="absolute inset-[18.85%_1.61%_4.48%_7.91%] overflow-clip rounded-[30px]" data-name="patient monitoring">
        ...
        <div className="absolute font-['Source_Code_Pro:Bold',_sans-serif] font-bold inset-[12.6%_56.31%_65.28%_1.7%] leading-[24px] text-[24px] text-black text-nowrap tracking-[3.6px] whitespace-pre">
          ...
          <p className="mb-0">Doctor-In-Charge: {record.doctorInCharge}</p>
          <p className="mb-0">Appointment Schedule: {record.appointmentSchedule}</p>
          <p>Duration (Minutes): {record.duration}</p>
        </div>
